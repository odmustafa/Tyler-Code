   ...
   public class Form1 : System.Windows.Forms.Form
   {
      ...
      private void InitBtn_Click(object sender, System.EventArgs e)
      {
         ...
         m_DeviceOpened = false;
			...
			else if (comboBoxDeviceName.Text == "USB FDU06AP(UPx-AP)")
				device_name = SGFPMDeviceName.DEV_FDU06AP;
			else if (comboBoxDeviceName.Text == "USB FDU08AL(U20AL)")
				device_name = SGFPMDeviceName.DEV_FDU08AL;
